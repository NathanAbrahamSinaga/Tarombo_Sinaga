  ...
  return (
    <div className="min-h-screen bg-[#FFF8E5]">
      ...
      <main className="container mx-auto mt-8">
        <h2 className="text-xl sm:text-lg font-bold mb-4 text-[#8B0000] text-center">TAROMBO TOGA SINAGA - BONOR SUHUT NI HUTA</h2>
        <h2 className="text-lg sm:text-md font-bold mb-4 text-[#8B0000] text-center">HUTA SOSOR LONTUNG, PARBABA DOLOK, SAMOSIR</h2>
